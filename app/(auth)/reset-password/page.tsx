...
export default function ResetPasswordPage() {
  ...
  return (
    <div className="bg-[#1a1d23] rounded-2xl p-8 shadow-2xl border border-white/5">
      ...
      <p className="text-gray-400 text-sm mb-6">Enter a new password for your account.</p>

      <form action={action} className="space-y-4">
        <div>
          <label className="block text-sm text-gray-400 mb-1" htmlFor="password">New password</label>
          <input
            id="password"
            name="password"
            type="password"
